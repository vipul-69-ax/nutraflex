...
export default function NutritionProfileForm() {
  ...
  const getValues=async()=>{
    ...
    setValue("dietaryRestrictions",data.dietary_restrictions)
    setValue("selectedRestrictions",data.selected_restrictions)
    setValue("allergies", data.allergies)
    setValue("selectedAllergies",data.selected_allergies)
    setValue("otherAllergies",data.other_allergies)
